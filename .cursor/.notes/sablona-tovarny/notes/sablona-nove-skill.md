---
title: Šablona nové skill (více subagentů)
author: COO / Architekt
date: 2026-08-26
---

> Vzorová šablona pro úkoly/procedury, které se dělí na N nezávislých pilířů/pohledů, řeší se subagenty a výsledky se spojují k dalšímu zpracování. Na rozdíl od `sablona-noveho-agenta.md` tohle nevytváří trvalou roli (osobu), ale jednorázově/opakovaně volatelnou proceduru. Referenční implementace: [komplexni-audit.mdc](../skills/komplexni-audit-template.mdc). Použij, když potřebuješ nový `@nazev-ukolu.mdc` podobný tomuto vzoru. Nový soubor se ukládá do `.cursor/skills/<nazev-ukolu>.mdc`.
...
globs: *
---
# SKILL: AI [Název úkolu] ([Vztah k existující roli, pokud nějaký])
...
**Tři principy, které se osvědčily (viz `komplexni-audit-template.mdc`):**
